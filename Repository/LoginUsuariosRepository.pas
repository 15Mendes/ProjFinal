...
constructor TLoginUsuarioRepository.Create;
begin
...
destructor TLoginUsuarioRepository.Destroy;
begin
  FQuery.Free;
  inherited;
end;

procedure TLoginUsuarioRepository.Inserir(AUser: TLUsuarios);
begin
  FQuery.Close;
...
procedure TLoginUsuarioRepository.Atualizar(AUser: TLUsuarios);
begin
  FQuery.Close;
...
procedure TLoginUsuarioRepository.Excluir(const AUsername: string);
begin
  FQuery.Close;
...
function TLoginUsuarioRepository.GetByUsername(const AUsername: string): TLUsuarios;
begin
  Result := nil;
  FQuery.Close;
